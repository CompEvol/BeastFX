...
//        partitionlist.selectItems(0, 1, 2, 3, 4);
		...
		list.getSelectionModel().selectIndices(0, 1, 2, 3, 4);
        ...
        robot.clickOn("#substModel").clickOn("JC69");
        robot.clickOn("gammaCategoryCount");robot.write("6");
        printBeautiState();
        ...
        robot.clickOn("shape.isEstimated");
        robot.clickOn("gammaCategoryCount");robot.write("1");
        printBeautiState();
		...
		list.getSelectionModel().selectIndices(0, 1);
        //beautiFrame.comboBox().selectItem(1);
		robot.clickOn(".combobox").clickOn("2ndpos");
        robot.clickOn("#ok");
...
//	    }
        ...
        robot.clickOn(".comboBox()").clickOn("Relaxed Clock Exponential");
        printBeautiState();
		...
		list.getSelectionModel().selectIndices(0, 1, 4);
...
//        beautiFrame.button("ok").click();
		...
		robot.clickOn(".combobox").clickOn("Relaxed Clock Log Normal");
        printBeautiState();
		...
		list.getSelectionModel().selectIndices(2, 3);
