...
public class BeasyMethodsServer extends Runnable {
	BeautiDoc beautiDoc;
	Beauti beauti;
	String html;
	List<Phrase> m;
	XML2Text xml2textProducer;
	final BeasyHTMLProducer htmlProducer = new BeasyHTMLProducer();
	
	File tmpFile = null;
	File file = null;
	
	public BeasyMethodsServer() {
	...
	public BeasyMethodsServer(BeautiDoc doc) {
		beautiDoc = doc;
		beauti = new Beauti(beautiDoc);
	}
...
System.out.println(response);
        		...
        		try {
        			CompactAnalysisByAntlr parser = new CompactAnalysisByAntlr(beautiDoc);
        			parser.parseCA(request + ";");
    ...
    public static void main(String[] args) throws Exception {
		MCMC mcmc = null;
		BeasyMethodsServer server = new BeasyMethodsServer();
